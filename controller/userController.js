...
const createNewUser = asyncHandler(async (req, res) => {
    ...
    ? { name, "password": hashedPwd, email, phone }
    : { name, "password": hashedPwd, email, phone, roles }
...
const updateUser = asyncHandler(async (req, res) => {
    const { id, name, email, phone, roles, active, password } = req.body

    // Confirm data 
    if (!id || !name || !email || !phone || !Array.isArray(roles) || !roles.length || typeof active !== 'boolean') {
